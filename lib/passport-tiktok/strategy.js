    ...
    this._oauth2._request("POST", url, {}, JSON.stringify(params), accessToken, function (err, body, res) {
        ...
        try {
            ...
            var profile = {
                ...
                profileImageLarge: json.data.user.avatar_large_url,
                ...
                followingCount: json.data.user.following_count,
                videoCount: json.data.user.video_count,
                likesCount: json.data.user.likes_count,
                tiktokDeepLink: json.data.user.profile_deep_link,
